...
{
	REQUIRE(get_bool_order_of_ops(true, false, true) == false);
	REQUIRE(get_bool_order_of_ops(false, true, false) == true);
	REQUIRE(get_bool_order_of_ops(false, false, false) == true);
}
